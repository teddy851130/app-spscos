...
- [**Project — Sprint04 진행 상태**](project_sps_sprint04.md) — **★ 다음 세션 첫 진입점**. PR16~PR22-Lite + 2026-04-22 실사용 피드백 fix 7커밋 · per-contact tracking 전환 · Edge Function 재배포 누락 교훈 · 4/25 1차 발송 대기 · 5/10 최종 판정
- [Project — SPS 바이어 앱 현재 상태](project_sps_buyer_app.md) — PR6~PR22 + 4/22 fix 이력 · per-contact tracking · 수동 초안 경로 단일화
